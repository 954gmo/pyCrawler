...
def win_run():
    ...
    # QueueManager.register('get_task_queue', callable=lambda: get_task)
    QueueManager.register('get_result_queue', callable=get_result)
    # QueueManager.register('get_task_queue', callable=lambda: get_result)
    ...
    try:
        ...
        print('try get result...')
        for i in range(10):
            print(f'result is{result.get(timeout=10)}')
